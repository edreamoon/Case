    ...
    private void initListener() {
        ...
        findViewById(R.id.bt_two_transition6).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mContent.getCurrentTextColor() == TransitionUtils.getColor(context, 8)) {
                    mContent.setTextColor(TransitionUtils.getColor(context, 0));
                } else {
                    mContent.setTextColor(TransitionUtils.getColor(context, 8));
                }
            }
        });
